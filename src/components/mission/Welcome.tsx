...
const STEPS_INFO = [
  ...
  { icon: '📝', name: 'Word Time', img: '/images/ui/steps/words.webp', nameZh: '學單字', desc: '用字卡學今天要學的英文字！看圖片、聽發音、跟著大聲念出來，還可以錄下自己的聲音，比比看誰念得標準！', voiceZh: '接下來學新單字！看圖片、聽發音、跟著念，還可以錄自己的聲音喔！' },
  { icon: '🎮', name: 'Challenge', img: '/images/ui/steps/challenge.webp', nameZh: '挑戰遊戲', desc: '用小遊戲玩一玩剛學到的東西！有用聽的、有連連看、有拼拼看，做對就能拿到星星，一直做對還會加分！', voiceZh: '第三關是挑戰遊戲！用遊戲練習剛學的東西，答對就有星星！' },
        ...
        <div className="max-w-xl mx-auto mb-6 animate-slide-up">
          <div className="flex justify-center gap-3 mb-4">
            {STEPS_INFO.map((step, i) => (
              ...
              >
                <img src={step.img} alt={step.nameZh} className="w-12 h-12 object-contain" />
              </button>
            ))}
          </div>
          ...
          {showStepDetail !== null && (
            <div className="bg-white rounded-2xl p-5 border-2 border-green-100 shadow-md animate-slide-up">
              <div className="flex items-center gap-3 mb-2">
                <img src={STEPS_INFO[showStepDetail].img} alt="" className="w-14 h-14 object-contain" />
                <div>
