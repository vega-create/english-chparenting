...
export const WORLDS = [
  { name: "彩虹谷", emoji: "🌈", nameEn: "Rainbow Valley", levels: [1, 2], color: "from-red-100 to-orange-100", image: "/images/worlds/world-rainbow-valley.webp" },
  { name: "友善小鎮", emoji: "🏡", nameEn: "Friendly Town", levels: [3, 4], color: "from-yellow-100 to-amber-100", image: "/images/worlds/world-friendly-town.webp" },
  { name: "海洋灣", emoji: "🌊", nameEn: "Ocean Bay", levels: [5, 6], color: "from-cyan-100 to-blue-100", image: "/images/worlds/world-ocean-bay.webp" },
  { name: "故事城堡", emoji: "🏰", nameEn: "Story Castle", levels: [7, 8], color: "from-purple-100 to-violet-100", image: "/images/worlds/world-story-castle.webp" },
  { name: "探索大陸", emoji: "🌍", nameEn: "Discovery Land", levels: [9, 10], color: "from-green-100 to-emerald-100", image: "/images/worlds/world-explorer-land.webp" },
  { name: "冠軍峰", emoji: "🎓", nameEn: "Champion Peak", levels: [11, 12], color: "from-pink-100 to-rose-100", image: "/images/worlds/world-champion-peak.webp" },
];

export const ISLAND_IMAGES: Record<number, string> = {
  1: "/images/islands/island-letter.webp",
  2: "/images/islands/island-sound.webp",
  3: "/images/islands/island-market.webp",
  4: "/images/islands/island-school.webp",
  5: "/images/islands/island-coral.webp",
  6: "/images/islands/island-lighthouse.webp",
  7: "/images/islands/island-grammar.webp",
  8: "/images/islands/island-question.webp",
  9: "/images/islands/island-time.webp",
  10: "/images/islands/island-future.webp",
  11: "/images/islands/island-challenge.webp",
  12: "/images/islands/island-victory.webp",
};

export const BADGE_IMAGES: Record<number, string> = {
  1: "/images/badges/badge-l1.webp",
  2: "/images/badges/badge-l2.webp",
  3: "/images/badges/badge-l3.webp",
  4: "/images/badges/badge-l4.webp",
  5: "/images/badges/badge-l5.webp",
  6: "/images/badges/badge-l6.webp",
  7: "/images/badges/badge-l7.webp",
  8: "/images/badges/badge-l8.webp",
  9: "/images/badges/badge-l9.webp",
  10: "/images/badges/badge-l10.webp",
  11: "/images/badges/badge-l11.webp",
  12: "/images/badges/badge-l12.webp",
};
...
export const COURSES: Course[] = [
  {
    ...
    skills: ["字母辨識", "大小寫配對", "字母發音", "常見字", "冠詞 a/an", "綜合閱讀"],
    vocabulary: 60, lessons: 20,
    topics: ["26 字母大寫", "26 字母小寫", "字母歌", "字母書寫", "常見字 sight words", "冠詞 a/an", "綜合閱讀"],
  ...
  {
    level: 7, slug: "l7-grammar-gate", island: "魔法門", islandEn: "Magic Gate",
    world: "故事城堡", worldEmoji: "🏰",
    color: "bg-purple-50", borderColor: "border-purple-200", bgGradient: "from-purple-50 to-violet-50", tag: "魔法句",
    description: "學會把話說對的「魔法句」",
    longDescription: "推開魔法門，學會神奇的「魔法句」把話說對！自然學會說每天的習慣、頻率（always / sometimes / never）和位置（in / on / at），讓 Finn 和朋友們的英文從「會說」升級到「說得剛剛好」。",
    skills: ["每天習慣說法", "頻率魔法句", "位置說法", "動作變變變"],
    vocabulary: 400, lessons: 20,
  ...
  },
  {
    ...
    color: "bg-pink-50", borderColor: "border-pink-200", bgGradient: "from-pink-50 to-rose-50", tag: "綜合大冒險",
    description: "把學過的全部本領融會貫通",
    longDescription: "踏進挑戰場，把一路上學到的本領全部融合！聽、說、讀、寫四種能力一起出動，闖過各種關卡。越玩越熟練，Finn 他們陪你把英文變成真本事。",
    skills: ["聽說讀寫全出動", "綜合闖關", "越玩越強", "臨場應變"],
    vocabulary: 750, lessons: 20,
    topics: ["聽提示找答案", "讀故事解謎", "魔法句大集合", "主題寫小卡", "看圖說故事"],
  ...
  },
  {
    ...
    world: "冠軍峰", worldEmoji: "🎓",
    color: "bg-rose-50", borderColor: "border-rose-200", bgGradient: "from-rose-50 to-pink-50", tag: "畢業大冒險",
    description: "最終試煉、畢業典禮、勇者認證",
    longDescription: "登上勝利峰的最後一段路！用一路學會的本領闖過最終試煉，完成後獲得專屬畢業證書，成為真正的英文小勇者。這是 Finn 和朋友們陪你走完的冒險終點，也是新旅程的起點！",
    skills: ["最終試煉", "本領大集合", "勇者認證", "成果展示"],
    vocabulary: 850, lessons: 20,
    topics: ["綜合大關卡", "開口說故事", "寫下你的冒險", "畢業挑戰賽", "成果展示"],
